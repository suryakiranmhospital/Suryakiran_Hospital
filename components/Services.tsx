...
import { Stethoscope, Baby, HeartPulse, Thermometer, Activity, Bone } from "lucide-react";
...
export default function Services() {
  return (
    <section id="services" className="section-padding bg-silver-50">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            ...
            >
              ...
              {/* Content */}
              <h3 className="font-montserrat font-semibold text-xl text-slate-800 mb-3">
                {service.title}
              </h3>
              ...
              {/* Learn more link */}
              <div className="mt-4 flex items-center gap-2 text-teal-600 font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300">
